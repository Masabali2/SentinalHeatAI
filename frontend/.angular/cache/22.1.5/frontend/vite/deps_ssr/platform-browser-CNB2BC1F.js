import { Al as ɵɵinject, Ar as _sanitizeUrl, Bn as LOCALE_ID, Br as bypassSanitizationTrustUrl, Cl as stringify, Cr as TracingService, Dc as Injector, Dl as ɵɵdefineInjector, Dn as Host, Do as ɵɵgetInheritedFactory, Dr as ViewEncapsulation, Ec as InjectionToken, El as ɵɵdefineInjectable, En as ElementRef, Er as ViewContainerRef, F as createPlatformFactory, Fc as NgZone, Fn as Injectable, Gi as setDocument, In as Input, Io as ɵɵinjectAttribute, Ir as bypassSanitizationTrustHtml, Jr as createNgModule, Lc as PLATFORM_ID, Ll as require_cjs, Lr as bypassSanitizationTrustResourceUrl, Nr as allLeavingAnimations, O as booleanAttribute, Pn as Inject, Pr as allowSanitizationBypassAndThrow, Pt as CACHE_ACTIVE, Qi as unwrapSafeValue, Qn as Optional, Qr as findLocaleData, Rc as PLATFORM_INITIALIZER, Rr as bypassSanitizationTrustScript, Rs as ɵɵstyleProp, Sc as IMAGE_CONFIG_DEFAULTS, Tc as INTERNAL_APPLICATION_ERROR_HANDLER, Ti as performanceMarkFeature, Tr as USE_PENDING_TASKS, Uc as RuntimeError, Ui as setClassMetadata, Vn as LocaleDataIndex, Wc as SecurityContext, Xc as _global, Yt as APP_BOOTSTRAP_LISTENER, Z as internalCreateApplication, Zn as NgModuleRef$1, ao as ɵɵdirectiveInject, ar as RendererFactory2, br as TestabilityRegistry, bt as withI18nSupport$1, ca as ɵɵNgOnChangesFeature, di as getLocalePluralCase$1, dr as Service, er as Pipe, fc as CSP_NONCE, fn as Console, gc as ENVIRONMENT_INITIALIZER, hc as DestroyRef, hr as TESTABILITY_GETTER, io as ɵɵdefineService, ir as Renderer2, jn as IS_ENABLED_BLOCKING_INITIAL_NAVIGATION, kr as _sanitizeHtml, m as KeyValueDiffers, mc as DOCUMENT, mn as DEFAULT_CURRENCY_CODE, mr as TESTABILITY, nl as formatRuntimeError, nn as Attribute, no as ɵɵdefineNgModule, or as RendererStyleFlags2, ot as platformCore, p as IterableDiffers, pl as makeEnvironmentProviders, qc as Version, qn as NgModule, qt as untracked, r as ChangeDetectorRef, rl as forwardRef, ro as ɵɵdefinePipe, rt as numberAttribute, sl as inject, sr as SHARED_STYLES_HOST, t as ApplicationModule, tn as ApplicationRef, to as ɵɵdefineDirective, uc as APP_ID, ul as isSignal, ut as provideStabilityDebugging, vi as isPromise, vr as TemplateRef, vt as withDomHydration, wc as INJECTOR_SCOPE, wn as Directive, xc as IMAGE_CONFIG, xt as withIncrementalHydration$1, yc as ErrorHandler, yi as isSubscribable, yr as Testability, yt as withEventReplay$1, zr as bypassSanitizationTrustStyle } from "./core-DI804xF1.js";
import { G as getDOM, H as DomAdapter, J as parseCookieValue, K as setRootDomAdapter, W as PlatformLocation, r as withHttpTransferCache } from "./http-CtywL8T2.js";
...
var DomRendererFactory2 = class DomRendererFactory2 {
	...
	createRenderer(element, type) {
		...
		if (type.encapsulation === ViewEncapsulation.ShadowDom || type.encapsulation === ViewEncapsulation.ExperimentalIsolatedShadowDom) type = {
			...type,
...
var DefaultDomRenderer2 = class {
	...
	decoratePreventDefault(eventHandler) {
		return (event) => {
			...
			if (this.ngZone.runGuarded(() => eventHandler(event)) === false) event.preventDefault();
		};
	}
};
...
//#endregion
export { EventManagerPlugin as A, HashLocationStrategy as B, createApplication as C, DomRendererFactory2 as D, DomEventsPlugin as E, NullViewportScroller as F, Location as H, PLATFORM_SERVER_ID as I, ViewportScroller as L, SharedStylesHost as M, provideCssVarNamespacing as N, EVENT_MANAGER_PLUGINS as O, NavigationAdapterForLocation as P, PRECOMMIT_HANDLER_SUPPORTED as R, bootstrapApplication as S, provideProtractorTestingSupport as T, LocationStrategy as U, APP_BASE_HREF as V, PathLocationStrategy as W, withNoIncrementalHydration as _, HydrationFeatureKind as a, BrowserModule as b, VERSION as c, provideClientHydration as d, withEventReplay as f, withNoHttpTransferCache as g, withIncrementalHydration as h, DomSanitizerImpl as i, REMOVE_STYLES_ON_COMPONENT_DESTROY as j, EventManager as k, disableDebugTools as l, withI18nSupport as m, CssVarNamespacer as n, Meta as o, withHttpTransferCacheOptions as p, DomSanitizer as r, Title as s, By as t, enableDebugTools as u, BrowserDomAdapter as v, platformBrowser as w, KeyEventsPlugin as x, BrowserGetTestability as y, PlatformNavigation as z };
